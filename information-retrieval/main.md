...
- F-score@k $2 \cdot \frac{P@k\cdot R@k}{P@k+R@k}$
...
> - Issue: `demon - Mephistopheles` are equally separate concepts as `demon - lasagne`
...
- Estimation results in tf-idf with logarithmically damped idfs
...
- How to represent a query/document as a fixed size vector? Can we model word co-occurence for a topic?
